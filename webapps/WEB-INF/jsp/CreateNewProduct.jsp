...
<body>
	<div class="container">
		...
		<form method="post" action="createNewProduct.post">
			...
			<p>
				<input type="text" name="productName" placeholder="name of the product" class="textfield"> Name of the product
			</p>
			...
			<br> <input type="SUBMIT" class="b1" value="Create new Product">
